      ...
      <div className="hidden lg:flex w-1/2 relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-white px-12">
          ...
          <h1 className="text-4xl font-bold mb-4 leading-tight">
            Join <span className="text-emerald-300">CivicConnect</span>
          </h1>
          <p className="text-lg text-emerald-100 max-w-md">
            Report civic issues, support your community, and help create
          ...
          <div className="mt-8 space-y-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-emerald-100">Make your voice heard</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-8 h-8 bg-emerald-500/30 rounded-lg flex items-center justify-center">✓</span>
              <span className="text-emerald-100">Connect with your community</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-8 h-8 bg-emerald-500/30 rounded-lg flex items-center justify-center">✓</span>
              <span className="text-emerald-100">Help improve your city</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="bg-white/90 backdrop-blur-xl border border-white/40 p-8 rounded-3xl shadow-2xl w-full max-w-md">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 mt-1">Join your community in making a difference</p>
          </div>

          {message && (
            <div className="bg-green-50 border border-green-200 text-green-700 text-sm p-3 rounded-xl mb-4 text-center flex items-center justify-center gap-2">
              <span>🎉</span>
              {message}
            </div>
          )}
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 text-red-700 text-sm p-3 rounded-xl mb-4 text-center flex items-center justify-center gap-2">
              <span>⚠️</span>
              {error}
            </div>
          )}
